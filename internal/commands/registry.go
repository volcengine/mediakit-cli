...
var generatedCapabilities = []CapabilityMeta{
		...
		Params: []ParamMeta{
			{
				Name:        "video_url",
				FlagName:    "video-url",
				Description: "输入视频资源 Url，支持 http/https 直链或 mediakit/tos/vod 平台资源链接；与 audio_url 二选一，都存在时优先取 video_url",
				Type:        "string",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
			},
			{
				Name:        "audio_url",
				FlagName:    "audio-url",
				Description: "输入视频资源 Url，支持 http/https 直链或 mediakit/tos/vod 平台资源链接；与 audio_url 二选一，不能都为空",
				Type:        "string",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
			},
			{
				...
				Description:  "输出音频格式，支持 mp3、wav、aac、m4a、flac，默认 aac",
				Type:         "string",
				Required:     false,
				Enum:         []string{"aac", "mp3", "wav", "m4a", "flac"},
				HasDefault:   true,
				DefaultValue: "aac",
				JSONEncoded:  false,
			},
	...
	},
	{
		...
		Params: []ParamMeta{
			...
			},
			{
				...
				FlagName:    "experimental-version",
				Description: "实验版本，用于内部业务传入特定版本模型，官网文档不提供该字段。可选值，0.2、1.0等。非必填",
				Type:        "string",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
			...
			{
				Name:        "generation_weight",
				FlagName:    "generation-weight",
				Description: "生成强度。数值越大表示增强/生成强度越大，数值越小表示越遵循原片。建议最小取值是 0.4。非必填",
				Type:        "number",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
	...
	{
		Name:              "enhance-video-fast",
		DisplayName:       "视频画质增强极速版",
		Domain:            "video",
		Description:       "集成轻量级超分与智能画质增强能力，采用速度优先算法优化策略，高效兼顾处理效率与画面效果，适配各类时延敏感型业务场景。",
		LocalSupported:    false,
		Async:             true,
		AsyncQueryCommand: "query-task",
		OutputType:        "video",
		Params: []ParamMeta{
			...
			},
			{
				Name:        "resolution_limit",
				FlagName:    "resolution-limit",
				Description: "指定输出视频的短边像素值，取值范围为 [128, 2160]。设置后，系统将锁定视频的短边像素值为设定值，并在保持原视频宽高比的前提下，等比缩放至该限制值。示例：若原视频为 640x480 (4:3)，设置 resolution_limit 为 720，则输出视频的短边将提升至 720，宽度等比缩放至 960。配置此参数后，不可同时配置resolution字段",
				Type:        "integer",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
			...
			},
			{
				Name:        "fps",
				FlagName:    "fps",
				Description: "目标帧率，单位为 fps。取值范围为 [15, 120]。",
				Type:        "number",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
	...
	},
	{
		...
		Params: []ParamMeta{
			...
			{
				Name:        "video_ending_mode",
				FlagName:    "video-ending-mode",
				Description: "高光智剪视频结尾选取模式。ReuseMainEnding=优先复用正片剧集结尾；SmartSelect=智能选取模式。不传则由后端按默认策略兜底。",
				Type:        "string",
				Required:    false,
				Enum:        []string{"ReuseMainEnding", "SmartSelect"},
				HasDefault:  false,
				JSONEncoded: false,
			},
			{
				Name:        "enable_segment_tag",
				FlagName:    "enable-segment-tag",
				Description: "是否在结果中输出高光片段/分镜的标签信息（tags 字段）。不传或 false = 不返回 tags；true = 在 clips 与 storyboard_info 中返回 tags，并透传给底层。",
				Type:        "boolean",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: false,
	...
	{
		Name:              "video-understand-router",
		DisplayName:       "视频理解智能策略",
		Domain:            "video",
		Description:       "基于视觉大模型的通用视频内容分析算子，对输入的视频 URL 列表进行智能分析，\n输出视频级别的结构化理解结果，适用于内容审核、视频检索、标签生成等场景。\n使用限制：单次最多输入 10 个视频，单个视频时长不超过 2 小时。",
		LocalSupported:    false,
		Async:             true,
		AsyncQueryCommand: "query-task",
		OutputType:        "file",
		Params: []ParamMeta{
			{
				Name:        "video_urls",
				FlagName:    "video-urls",
				Description: "待处理的视频 URL 列表，支持 HTTP/HTTPS 公网可访问链接，最多 10 个视频\n子项说明：视频 URL",
				Type:        "array",
				ItemType:    "string",
				Required:    true,
				HasDefault:  false,
			...
			},
			{
				Name:         "level",
				FlagName:     "level",
				Description:  "分析档位, 可选值: Economy, Balanced, Quality",
				Type:         "string",
				Required:     false,
				Enum:         []string{"Economy", "Balanced", "Quality"},
				HasDefault:   true,
				DefaultValue: "Economy",
				JSONEncoded:  false,
			},
			{
				Name:        "prefer_endpoints",
				FlagName:    "prefer-endpoints",
				Description: "优先使用指定的自定义推理点列表，最多 10 个，优先级高于prefer_models\n子项说明：指定使用的自定义推理点",
				Type:        "array",
				ItemType:    "string",
				Required:    false,
				HasDefault:  false,
			...
			{
				Name:        "prefer_models",
				FlagName:    "prefer-models",
				Description: "优先使用指定的模型列表，最多 10 个模型\n子项说明：指定使用的模型",
				Type:        "array",
				ItemType:    "string",
				Required:    false,
				HasDefault:  false,
			...
			{
				Name:        "manual_option",
				FlagName:    "manual-option",
				Description: "手动模式相关参数",
				Type:        "object",
				Required:    false,
				HasDefault:  false,
				JSONEncoded: true,
	...
	},
	{
		...
		Params: []ParamMeta{
			...
			},
			{
				...
				Type:         "string",
				Required:     false,
				Enum:         []string{"standard", "professional", "max"},
				HasDefault:   true,
				DefaultValue: "standard",
				JSONEncoded:  false,
			},
